...
struct Message: Identifiable {
    ...
    static var messages: [Message] = [
        ...
        Message(photo: "avatar5", name: "Ayoub Saidia", hourReception: "15:22", messageContent: "Subscribe to Apprendre SwiftUI 💙"),
